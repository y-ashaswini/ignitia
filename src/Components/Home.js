...
export default function Home() {
  const { u_email, u_fname, u_lname } = useContext(userDataContext);
  return (
    <div className="w-full h-full bg-slate-100 rounded-3xl p-5 flex flex-col border-r-8 border-b-8 border-2 border-slate-800">
      {u_email ? (
        <>
          <div className="text-slate-600 text-2xl">Welcome Back,</div>
          <div className="text-3xl text-slate-600 bg-bbglue w-fit px-2 py-1 border-2 border-b-8 border-r-8 border-slate-800 mb-2">
            {u_fname + " " + u_lname}
          </div>

          <div className="text-[6vh] text-slate-600 mb-2"></div>
            ...
            <span className="flex flex-col gap-2">
              ...
              <span className="flex gap-4">
                <span className="bg-white p-4 rounded-md flex flex-col gap-2 px-8 border-2 border-r-8 border-b-8 border-slate-700 ">
                  <span className="flex flex-col gap-1 text-slate-400 text-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="w-12 h-12 text-slate-600 opacity-50 hover:opacity-100 cursor-pointer"
                    >
                      <path
                        fill-rule="evenodd"
                ...
                <span className="bg-white p-4 rounded-md flex flex-col gap-2 px-8 border-2 border-r-8 border-b-8 border-slate-700 ">
                  <span className="flex flex-col gap-1 text-slate-400 text-center">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="w-12 h-12 hover:text-slate-600 cursor-pointer mx-auto"
                    >
